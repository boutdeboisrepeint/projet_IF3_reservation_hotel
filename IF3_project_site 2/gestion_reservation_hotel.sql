...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 07 nov. 2025 à 00:06
...
INSERT INTO `guest` (`guest_id`, `last_name`, `first_name`, `email`, `loyality_points`, `phone`, `adress`, `login`, `password`, `registration_date`, `date_of_birth`) VALUES
(7, 'Rasquin', 'Arnaud', 'arnaud57.rasquin@gmail.com', 0, '0768235528', '8 bis Rue de Delle', 'AA', '$2y$10$t9elD931gPX0NAK6QofqW.xP.UB7MNT0IAz2vRGonYP.zsCBp7OzS', '2025-11-06', '2025-11-29'),
(10, 'Rasquin', 'Arnaud', 'arnaud.rasquin@gmail.com', 0, '0768235521', '8 bis Rue de Delle', 'AAA', '$2y$10$SfG4n8bGqJd.ML4vNPBg2.lr7i6G1if7bKxQF73OhxeLHCREmQ3l6', '2025-11-07', '2025-11-26');
...
INSERT INTO `reservation` (`id_reservation`, `number_of_guest`, `status`, `check_in_date`, `check_out_date`, `room_id`, `total_price`, `booking_date`, `guest_id`) VALUES
(1, 1, 'confirmée', '2025-11-27', '2025-11-22', 1, 750, '2025-11-06', 7),
(2, 1, 'confirmée', '2025-11-20', '2025-11-27', 5, 1260, '2025-11-06', 7),
(3, 1, 'confirmée', '2025-11-26', '2025-11-29', 2, 450, '2025-11-07', 10);
...
(1, 101, 'Occupée', 1, 150.00),
(2, 102, 'Occupée', 1, 150.00),
(3, 201, 'Disponible', 2, 120.00),
(4, 202, 'Disponible', 2, 120.00),
(5, 301, 'Occupée', 3, 180.00),
(6, 302, 'En maintenance', 3, 180.00);
...
(1, 'Suite Junior', 'Grande suite avec salon, literie haut de gamme et vue sur la montagne.', 150.00, 2, 'WiFi, TV, Minibar, Douche à l\'italienne'),
(2, 'Chambre Deluxe', 'Chambre spacieuse avec balcon et lit king size, idéale pour les séjours romantiques.', 120.00, 2, 'WiFi, TV, Balcon, Climatisation'),
(3, 'Chambre Familiale', 'Confortable chambre pour 4 personnes avec deux lits doubles et coin salon.', 180.00, 4, 'WiFi, TV, Réfrigérateur, Bureau');
